            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                    ...
                    <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">
                        Community Sentinel is a powerful platform that empowers
                        users to proactively report and combat objectionable
                        content on various social media platforms. Join us in
                        safeguarding the online community and fostering a
                        positive digital experience for all.
                    </p>
                        ...
                        <div>
                            <div class="mb-10">
                                ...
                                <p class="text-gray-500 dark:text-gray-400">
                                    Community Sentinel is an innovative platform
                                    that enables users to proactively report
                                    objectionable content on various social
                                    media platforms. It serves as a digital
                                    sentinel, empowering individuals to
                                    contribute to a safer and more responsible
                                    online community.
                                </p>
                            </div>
                            <div class="mb-10">
                                ...
                                <p class="text-gray-500 dark:text-gray-400">
                                    Community Sentinel streamlines the reporting
                                    process by providing a centralized platform
                                    for reporting objectionable videos, streams,
                                    channels, and other types of content. Users
                                    can submit reports, provide relevant
                                    details, and choose the appropriate platform
                                    and content category. We ensure that the
                                    reports are promptly delivered to the
                                    respective social media platforms for review
                                    and action.
                                </p>
                            </div>
                            <div class="mb-10">
                                <h3 class="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                                    ...
                                    Which social media platforms does Community
                                    Sentinel support?
                                </h3>
                                <p class="text-gray-500 dark:text-gray-400">
                                    Community Sentinel currently supports
                                    popular social media platforms such as
                                    YouTube and TikTok. We are continuously
                                    expanding our network to include more
                                    platforms, ensuring comprehensive coverage
                            ...
                            <div class="mb-10">
                                <h3 class="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                                    ...
                                    through Community Sentinel?
                                </h3>
                                <p class="text-gray-500 dark:text-gray-400">
                                    Community Sentinel allows users to report a
                                    wide range of objectionable content,
                                    including offensive or hate speech, explicit
                                    or adult material, cyberbullying,
                                    harassment, spam, and fraudulent activities.
                                    We strive to address diverse concerns and
                                    foster a responsible and inclusive online
                                    community.
                                </p>
                            </div>
                        </div>
                        <div>
                            <div class="mb-10">
                                <h3 class="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                                    ...
                                    Is Community Sentinel affiliated with social
                                    media platforms?
                                </h3>
                                <p class="text-gray-500 dark:text-gray-400">
                                    No, Community Sentinel is an independent
                                    platform designed to complement existing
                                    reporting mechanisms provided by social
                                    media platforms. We collaborate with these
                                    platforms by forwarding the reports we
                                    receive from users to the appropriate
                                    channels, expediting the review and
                                    resolution process.
                                </p>
                            </div>
                            <div class="mb-10">
                                ...
                                <p class="text-gray-500 dark:text-gray-400">
                                    Yes, Community Sentinel is accessible to
                                    users worldwide. We believe in the
                                    importance of a global community working
                                    together to make the internet a safer place.
                            ...
                            <div class="mb-10">
                                <h3 class="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                                    ...
                                    How can I trust that my reports will be
                                    taken seriously?
                                </h3>
                                <p class="text-gray-500 dark:text-gray-400">
                                    While we cannot guarantee specific outcomes,
                                    Community Sentinel diligently ensures that
                                    your reports are delivered to the respective
                                    social media platforms for review. The
                                    platforms themselves have their own policies
                                    and processes for evaluating and addressing
                                    reported content.
                                </p>
                            </div>
                            <div class="mb-10">
                                ...
                                <p class="text-gray-500 dark:text-gray-400">
                                    Yes, Community Sentinel is completely free
                                    to use. We are committed to providing
                                    accessible community-driven accountability
                                    to all users. Our goal is to empower
                                    individuals without any financial barriers
