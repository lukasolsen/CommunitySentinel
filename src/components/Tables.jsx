...
function BigTable(props) {
  const [items, setItems] = useState([props.reportData]);
  ...
  const filteredItems = useMemo(() => {
    return items[0].filter((item) => {
      return (
        ...
        item.resolver.toLowerCase().includes(query.toLowerCase()) ||
              ...
              <div className="flex items-center flex-1 justify-center">
                ...
                <div className="relative w-full">
                  ...
                  <input
                    ...
                    placeholder="Search for any user or category..."
                  ...
                  {filteredItems.map((data) => {
                    return (
                      <tr className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer">
                        ...
                        <td className="px-4 py-3">{data.reportId}</td>
                        ...
                        <td className="px-4 py-3">{data.issuer}</td>
                        <td className="px-4 py-3">{data.resolver}</td>
                        <td className="px-4 py-3">{data.comments}</td>
                        <td className="px-4 py-3">{data.dateIssued}</td>
                      </tr>
                    );
                  })}
                </tbody>
            ...
            >
              <span className="text-sm font-normal text-gray-500 dark:text-gray-400">
                ...
                <span className="font-semibold text-gray-900 dark:text-white">
                  1-
                  {props.reportData.length > 10 ? 10 : props.reportData.length}
                </span>{" "}
                of
                <span className="font-semibold text-gray-900 dark:text-white">
                  {" "}
